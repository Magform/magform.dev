...
This post presents an analysis of different lossless image compression techniques applied to four images: three real-world images (baboon, house, and lake) and a randomly generated image. All images are grayscale with 256 different gray levels, resulting in a bit-per-pixel (bpp) value of 8 before compression.   
...
<div class="image-container">
    <img src="/assets/images/Compression_Algorithm/baboon.pgm" alt="baboon" title="baboon"/>
    <img src="/assets/images/Compression_Algorithm/house.pgm" alt="house" title="house"/>
    <img src="/assets/images/Compression_Algorithm/lake.pgm" alt="lake" title="lake"/>
    <img src="/assets/images/Compression_Algorithm/random_generated.pgm" alt="random_generated" title="random_generated"/>
</div>
...
### Comparison of Prediction Error with Different Algorithm
<div class="image-container">
...
<img src="/assets/images/Compression_Algorithm/advanced_prediction_error.jpg" title="Illustration of advanced spatial prediction"/>
